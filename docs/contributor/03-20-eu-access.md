...
When the **PlatformRegion** is an EU access BTP subaccount region, the following actions take place:

- Kyma Environment Broker (KEB) provides the **euAccess** parameter to Kyma Infrastructure Manager (KIM)
- The KEB service catalog restricts the available **region** parameter to the following supported cluster regions:
