...
# Check the API Using Swagger

With the Swagger UI, you can visualize Kyma Environment Broker's (KEB) APIs on a single page.
...
To port-forward the Pod and expose and use the Swagger UI, use the following command:
